...
def main():
    ...
    exit_button1 = Button(700, 450, exit_img)
    exit_button2 = Button(815, 400, exit_img)
    ...
    while run:
        ...
        if main_menu:
            ...
            if game_over == 0:
                ...
                draw_text('Level: ' + str(important_stuff.level_count + 1), score_font, yellow_font, 1185,
                          coin_height - 15)
            ...
            if game_over == -1:
                ...
                draw_text('Level: ' + str(important_stuff.level_count + 1), score_font, yellow_font, screen_width - 405,
                          screen_height - 525)
            ...
            if game_over == 2:
                ...
                draw_text('Congratulations! you have reached the end of the dungeon', score_font, yellow_font,
                          screen_width - 625, screen_height - 560)
                draw_text('Your score: ' + str(score), end_game_font, yellow_font, screen_width - 600, screen_height -
                          500)
